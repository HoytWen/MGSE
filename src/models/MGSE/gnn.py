...
class GINConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr, edge_weight= None):
        ...
        # return self.propagate(edge_index=edge_index[0], x=x, edge_attr=edge_embeddings, edge_weight=None)
...
class GNN_graphpred(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, num_tasks, mlp_layer=1, JK="last", drop_ratio=0, graph_pooling="mean", gnn_type="gin", ft_norm_type='batch', pred=False):
        ...
        self.ft_norm_type = ft_norm_type
    ...
    def forward(self, *argv):
        ...
        if self.pred:
            g = self.pool(node_representation, batch)
