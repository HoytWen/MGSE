...
if __name__ == "__main__":
    ...
    from MGSE.models.MGSE.loader import MoleculeDataset
    ...
    dataset = MoleculeDataset('dataset/bace', dataset='sider')
    smiles_list = pd.read_csv('dataset/bace/processed/smiles.csv', header=None)[
        0].tolist()
